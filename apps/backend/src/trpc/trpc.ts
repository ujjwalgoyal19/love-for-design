...
export const createTRPCContext = async (opts: {
  ...
  // Use extractSession to handle session validation
...
export const protectedProcedure = t.procedure
  ...
  .use(({ ctx, next }) => {
    // Type assertion to handle the session properly
    ...
    return next({
      ctx: {
        ...ctx,
        // infers the `session` as non-nullable with authenticated user
